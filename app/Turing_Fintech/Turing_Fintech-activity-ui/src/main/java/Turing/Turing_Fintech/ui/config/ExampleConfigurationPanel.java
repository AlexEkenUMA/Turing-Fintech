...
public class ExampleConfigurationPanel extends ActivityConfigurationPanel {
	...
	public ExampleConfigurationPanel(Activity activity, ServiceRegistry serviceRegistry) {
		super(activity);
