package Turing.Turing_Fintech.ui.menu;
...
public class ExampleConfigureMenuAction extends AbstractConfigureActivityMenuAction implements
	...
	protected Action createAction() {
		Action result = new ExampleConfigureAction(findActivity(), editManager, fileManager,
