package Turing.Turing_Fintech.ui.config;
...
public class ExampleConfigureAction extends ActivityConfigurationAction {

	private final EditManager editManager;
	private final FileManager fileManager;
	private final ServiceRegistry serviceRegistry;

	public ExampleConfigureAction(Activity activity,
	...
	public void actionPerformed(ActionEvent e) {
		...
		ExampleConfigurationPanel panel = new ExampleConfigurationPanel(getActivity(), serviceRegistry);
