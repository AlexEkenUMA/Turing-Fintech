...
public class ExampleActivityContextViewFactory implements ContextualViewFactory<Activity> {
	...
	public List<ContextualView> getViews(Activity selection) {
		return Arrays.<ContextualView>asList(new ExampleContextualView(selection, editManager,
