...
/**
 * Example <code>Activity<code>.
 */
public class ExampleActivity extends AbstractAsynchronousActivity<JsonNode>
		implements AsynchronousActivity<JsonNode> {

	public static final String ACTIVITY_TYPE = "http://example.com/2013/activity/Turing_Fintech";
