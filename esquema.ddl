CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, DTYPE VARCHAR(31), SWIFT VARCHAR, ESTADO BOOLEAN NOT NULL, FECHA_APERTURA DATE NOT NULL, SALDO DOUBLE, TIPO VARCHAR NOT NULL, COMISION DOUBLE, CR_IBAN VARCHAR, NOMBRE_BANCO VARCHAR NOT NULL, PAIS VARCHAR, SUCURSAL VARCHAR, SEGREGADA_IBAN VARCHAR, PRIMARY KEY (IBAN))
