...
CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, DTYPE VARCHAR(31), SWIFT VARCHAR, ESTADO BOOLEAN NOT NULL, FECHA_APERTURA DATE NOT NULL, SALDO DOUBLE, TIPO VARCHAR NOT NULL, NOMBRE_BANCO VARCHAR NOT NULL, PAIS VARCHAR, SUCURSAL VARCHAR, SEGREGADA_IBAN VARCHAR, COMISION DOUBLE, CR_IBAN VARCHAR, PRIMARY KEY (IBAN))
CREATE TABLE DIVISAS (ABREVIATURA VARCHAR NOT NULL, CAMBIO_EURO DOUBLE NOT NULL, NOMBRE VARCHAR NOT NULL, SIMBOLO CHAR, PRIMARY KEY (ABREVIATURA))
CREATE TABLE TRANSACCIONES (ID_UNICO BIGINT NOT NULL, CANTIDAD DOUBLE NOT NULL, COMISION DOUBLE, CONCEPTO VARCHAR, FECHA_INSTRUCCION TIMESTAMP NOT NULL, NOMBRE_EMISOR VARCHAR, TIPO_TRANSACCION VARCHAR NOT NULL, PRIMARY KEY (ID_UNICO))
