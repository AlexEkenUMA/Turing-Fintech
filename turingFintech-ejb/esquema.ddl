...
CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, DTYPE VARCHAR(31), SWIFT VARCHAR, ESTADO BOOLEAN NOT NULL, FECHA_APERTURA DATE NOT NULL, FECHA_CIERRE DATE, SALDO DOUBLE, TIPO VARCHAR NOT NULL, CLIENTE_ID BIGINT, NOMBRE_BANCO VARCHAR NOT NULL, PAIS VARCHAR, SUCURSAL VARCHAR, DIVISA_ABREVIATURA VARCHAR, SEGREGADA_IBAN VARCHAR, COMISION DOUBLE, PRIMARY KEY (IBAN))
